...
| Generate + pressure-test multiple approaches | `adversarial-brainstorm` |
| Clear requirements, need an implementation plan | `nord-plan` |
| Have a plan, ready to execute | `nord-exec` |
| Audit existing codebase | `multi-agent-codebase-audit` |
