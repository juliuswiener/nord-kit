...
| Inductor current ripple | `bom-manager`: confirm Isat rating from DigiKey |
...
- **CLI**: Reference calculations available via the `ee-reference` skill. No dedicated CLI subcommand.
