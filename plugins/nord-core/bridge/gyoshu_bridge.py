...
PARENT_WATCH_INTERVAL_S = max(
    float(os.environ.get("NORD_PARENT_POLL_INTERVAL_MS", "1000")) / 1000.0, 0.25
)
...
class ExecutionState:
    ...
    def _initialize_namespace(self):
        ...
        # Always restrict JSON-RPC supplied execution; NORD_PYTHON_SANDBOX no
...
def _get_expected_parent_pid() -> Optional[int]:
    ...
    raw_value = os.environ.get("NORD_PARENT_PID")
    if not raw_value:
        return None
